...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 18, 2023 at 09:11 AM
...
CREATE TABLE `account` (
  ...
  `seleted_template` varchar(255) NOT NULL,
...
INSERT INTO `account` (`id`, `username`, `email`, `password`, `sub_domain`, `about`, `title`, `profile_image`, `seleted_template`, `contact_number`) VALUES
(1, 'abc', 'abc3@gmail.com', 'adminpassword', 'abc', 'You can do this by first getting the domain name (e.g. sub.example.com => example.co.uk) and then use strstr to get the subdomains.', 'dsfdd', 'images/profile_image/93052153a9b0d76378865fc3150d6b03.jpeg', 'design43', '345345345'),
(5, '', '', '', '', NULL, '', NULL, '', ''),
...
(29, 'sdffsd', 'test324532@gmail.com', 'adminpassword', 'fdsfsf', 'fsdfsdafasd', 'sdffsd', 'images/profile_image/default_profile_image.webp', '', '345345345');
...
(8, 1, 'fsdfsd', 'sdfsd', 'fsdfds', 'fdsfsd');
