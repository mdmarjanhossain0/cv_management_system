...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($password != $confirm_password) {
            ...
            $sql = "INSERT INTO account (username, email, contact_number, sub_domain, title, profile_image, about, password) values ('$username', '$email', '$contact_number', '$sub_domain', '$profile_title', '$profile_image_path', '$about', '$password')";
        ...
        <div class="main-card">
            ...
            <div class="login-card">
                ...
                <form method="POST" action="register.php" enctype="multipart/form-data">
                    ...
                    <input type="text" placeholder="Contact Number" id="contact_number" name="contact_number" value="<?php echo  $contact_number; ?>" required />
